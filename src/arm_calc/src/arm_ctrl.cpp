...
void ArmCtrlNode::create_interfaces() {
    ...
    // joint_state_sub_ = this->create_subscription<robot_msgs::msg::Arm>(
    ...
    joint_target_pub_ = this->create_publisher<robot_msgs::msg::Arm>(kJointTargetTopic, 10);
 ...
 * @brief 关节状态消息回调
 *
 * 当收到来自关节驱动器的实时状态（robot_msgs::msg::Arm）时调用。
...
// 参数：msg - Arm消息
// 返回：JointState结构体
// JointState ArmCtrlNode::from_arm_message(const robot_msgs::msg::Arm& msg) {
//     JointState state;
...
// 参数：point - 轨迹点
// 返回：robot_msgs::msg::Arm消息
robot_msgs::msg::Arm ArmCtrlNode::to_arm_message(const JointTrajectoryPoint& point) {
