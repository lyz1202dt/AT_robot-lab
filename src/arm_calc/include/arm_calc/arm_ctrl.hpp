...
private:
    ...
    static robot_msgs::msg::Arm to_arm_message(const JointTrajectoryPoint& point);
    ...
    rclcpp::Subscription<robot_msgs::msg::Arm>::SharedPtr joint_state_sub_;
    ...
    rclcpp::Publisher<robot_msgs::msg::Arm>::SharedPtr joint_target_pub_;
