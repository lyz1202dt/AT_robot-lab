            ...
            auto start_stage15_cycle = [&](int phase) {
                ...
                if (phase == 0) {
                    lf_step.update_flight_trajectory(
                        lf_cart_pos, Vector3D(0.0, 0.0, 0.0), Vector3D(0.2, 0.0, 0.0), Vector3D(0.0, 0.0, 0.0), 1.0, 0.2);
                    ...
                    rb_step.update_flight_trajectory(
                        rb_cart_pos, Vector3D(0.0, 0.0, 0.0), Vector3D(0.2, 0.0, 0.0), Vector3D(0.0, 0.0, 0.0), 1.0, 0.2);
                } else {
                    lf_step.update_support_trajectory(lf_cart_pos, Vector3D(0.0, 0.0, -0.05), 1.0);
                    rf_step.update_flight_trajectory(
                        rf_cart_pos, Vector3D(0.0, 0.0, 0.0), Vector3D(0.2, 0.0, 0.0), Vector3D(0.0, 0.0, 0.0), 1.0, 0.2);
                    lb_step.update_flight_trajectory(
                        lb_cart_pos, Vector3D(0.0, 0.0, 0.0), Vector3D(0.2, 0.0, 0.0), Vector3D(0.0, 0.0, 0.0), 1.0, 0.2);
                    rb_step.update_support_trajectory(rb_cart_pos, Vector3D(0.0, 0.0, -0.05), 1.0);
                }
                cross_wall_stage_time = std::chrono::steady_clock::now();
            };
